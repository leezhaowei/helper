...
public class SwapTwoNumbers {
    ...
    /**
     * Bitwise operators can also be used to swap two numbers without using third variable. XOR bitwise operator returns
     * zero if both operand is same i.e. either 0 or 1 and returns 1 if both operands are different e.g. one operand is
     * zero and other is one. By leveraging this property, we can swap two numbers in Java. Here is code example of
     * swapping two numbers without using temp variable in Java using XOR bitwise operand: <br>
    ...
    /**
     * This is similar to first approach, where we have used + and - operator for swapping values of two numbers. Here
     * is the code example to swap tow number without using third variable with division and multiplication operators in
     * Java
     */
