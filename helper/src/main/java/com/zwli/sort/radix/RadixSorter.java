...
public class RadixSorter {
     ...
     */
    public void sort(final int[] keys, final int from, final int len, final int radix, final int d) {
        if (USE_LINK) {
    ...
    private void array_radix_sort(final int[] keys, final int from, final int len, final int radix, final int d) {
    ...
    private void link_radix_sort(final int[] keys, final int from, final int len, final int radix, final int d) {
    ...
    private void link_radix_sort_distribute(final int[] keys, final int from, final int len, final int radix,
            final int d, final int[] nexts, final LinkQueue[] queues, int first) {
    ...
    private int link_radix_sort_collect(final int[] keys, final int from, final int len, final int radix, final int d,
            final int[] nexts, final LinkQueue[] queues) {
        int first = 0;
        int last = 0;
        int fromQueue = 0;
    ...
    static int[] createArr(final int size) {
